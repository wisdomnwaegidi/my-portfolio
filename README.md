...
This website was built using HTML, CSS, and JavaScript. The website layout and styling were done using CSS, The website is hosted on a web server using a domain name and hosting service.

Features The website includes the following sections:
